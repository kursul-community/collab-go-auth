...
type ResendVerificationEmailRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Email         string                 `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`
	RequestId     string                 `protobuf:"bytes,2,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"` // Уникальный идентификатор запроса для отслеживания
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ResendVerificationEmailResponse struct {
	...
	RequestId     string                 `protobuf:"bytes,2,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"` // Возвращаем тот же request_id
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ResendVerificationEmailResponse) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
type VerifyEmailRequest struct {
	...
	RequestId     string                 `protobuf:"bytes,3,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"` // Уникальный идентификатор запроса для отслеживания
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type VerifyEmailResponse struct {
	...
	RequestId     string                 `protobuf:"bytes,3,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"` // Возвращаем тот же request_id
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *VerifyEmailResponse) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
const file_auth_proto_rawDesc = "" +
	...
	"\n" +
	"request_id\x18\x03 \x01(\tR\trequestId2\x91\x05\n" +
	"\x04Auth\x12[\n" +
	...
	"\vVerifyEmail\x12\x18.auth.VerifyEmailRequest\x1a\x19.auth.VerifyEmailResponse\",\x82\xd3\xe4\x93\x02&:\x01*\"!/api/v1/auth/sign-up/verify-emailB\x12Z\x10go-auth/gen/authb\x06proto3"
...
var file_auth_proto_depIdxs = []int32{
	...
	9,  // 10: auth.Auth.ResendVerificationEmail:output_type -> auth.ResendVerificationEmailResponse
	11, // 11: auth.Auth.VerifyEmail:output_type -> auth.VerifyEmailResponse
